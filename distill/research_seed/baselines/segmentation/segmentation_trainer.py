...
def main(hparams):
    ...
    student = torchvision.models.segmentation.__dict__[hparams.student_model](num_classes=hparams.num_classes,
                                                                 aux_loss=hparams.aux_loss,
                                                                 pretrained=hparams.pretrained)

    teacher = torchvision.models.segmentation.__dict__[hparams.teacher_model](num_classes=hparams.num_classes,
                                                                aux_loss=hparams.aux_loss,
                                                                pretrained=hparams.pretrained)
    ...
    model = KD_Segmentation(hparams, student, teacher)
