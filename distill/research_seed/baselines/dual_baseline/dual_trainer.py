...
from research_seed.baselines.dual_baseline.dual_model import Dual_Cifar
...
def main(hparams):
    ...
    model = Dual_Cifar(student, teacher, hparams)
...
if __name__ == '__main__':
    ...
    parser = Dual_Cifar.add_model_specific_args(parser)
